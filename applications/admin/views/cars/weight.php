        ...
        if ($list) {
            foreach ($list as $val) {
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('cars/delWeight', array('id' => $val['id'])) ?>" onclick="if(confirm('确定删除?')===false)return false;">删除</a>
                    </td>
                </tr>
            <?php } } ?>
    </table>
...
<div class="tips-show-module right-content add-module" style="z-index:9999999;width:auto;height:auto">
    ...
    <div class="right-table" style="margin-top: 30px;">
        新增重量：<?php echo CHtml::textField('name', '', array('maxlength' => 5,
