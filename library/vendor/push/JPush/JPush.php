...
//    public function __construct($appKey, $masterSecret, $logFile=self::DEFAULT_LOG_FILE, $retryTimes=self::DEFAULT_MAX_RETRY_TIMES) {
      public function __construct($logFile=self::DEFAULT_LOG_FILE, $retryTimes=self::DEFAULT_MAX_RETRY_TIMES) {
...
//        $this->masterSecret = $masterSecret;
        $this->appKey = JPUSH_APPKEY;
        $this->masterSecret = JPUSH_MASTERSECRET;
