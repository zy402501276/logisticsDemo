<?php
class IdentityCardValidator extends CValidator {
	...
	public function validateValue($num) {
		if(strlen($num) == 18)
                {
                    return $this->idcard_checksum18($num);
                }
                elseif((strlen($num) == 15))
                {
                    $id_card = $this->idcard_15to18($num);
